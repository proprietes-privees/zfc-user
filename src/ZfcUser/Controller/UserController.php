...
class UserController extends AbstractActionController
{
     ...
     * @var string
     */
    protected $failedLoginMessage = 'Authentification échouée. Merci de réessayer.';
    ...
    public function logoutAction()
    {
        ...
        if ($this->getOptions()->getUseRedirectParameterIfPresent() && $redirect) {
			...
			return $this->redirect()->toUrl($this->url()->fromRoute($this->getOptions()->getLogoutRedirectRoute()).'?redirect='. rawurlencode($redirect));
        }
    ...
    public function registerAction()
    {
        ...
        if ($service->getOptions()->getLoginAfterRegistration()) {
            ...
            } elseif (in_array('code', $identityFields)) {
                $post['identity'] = $user->getCode();
            }
