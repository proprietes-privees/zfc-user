    ...
    UserServiceOptionsInterface
{
     ...
     * @var int
     */
    protected $enableUserActive = false;

    /**
     * @var int
     */
    protected $defaultUserActive = 1;

    /**
     * @var Array
     */
    protected $allowedLoginActives = array( null, 1 );
     ...
     * @var array
     */
    protected $authIdentityFields = array('code');
    ...
    /**
     * get user active usage for registration/login process
     *
     * @return int
     */
    public function getEnableUserActive()
    {
        return $this->enableUserActive;
    }

    /**
     * set user active usage for registration/login process
     *
     * @param boolean $flag
     * @return ModuleOptions
     */
    public function setEnableUserActive($flag)
    {
        $this->enableUserActive = $flag;
        return $this;
    }

    /**
     * get default user active on registration
     *
     * @return int
     */
    public function getDefaultUserActive()
    {
        return $this->defaultUserActive;
    }

    /**
     * set default user active on registration
     *
     * @param int $active
     * @return ModuleOptions
     */
    public function setDefaultUserActive($active)
    {
        $this->defaultUserActive = $active;
        return $this;
    }

    /**
     * get list of actives to allow user login
     *
     * @return array
     */
    public function getAllowedLoginActives()
    {
        return $this->allowedLoginActives;
    }

    /**
     * set list of actives to allow user login
     *
     * @param Array $actives
     * @return ModuleOptions
     */
    public function setAllowedLoginActives(Array $actives)
    {
        $this->allowedLoginActives = $actives;
        return $this;
    }
     ...
     * @return ModuleOptions
     */
    public function setEnableCode($flag)
    {
        $this->enableCode = (bool) $flag;
        return $this;
    }
